...
export default () => {
    ...
    /**
     * Edit this global map code. Rather than render a Heatmap (which is slow and unwieldy, render based on the political
     *  NUTS3 regions. You can get the information and classify points into regions by parsing the addressPoints
     *  into
     *  You should use the median for each region score.
     *
     */
