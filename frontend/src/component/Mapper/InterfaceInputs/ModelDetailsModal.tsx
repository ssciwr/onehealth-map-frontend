...
import { Modal, List, Button, Typography, Space, Badge, Image } from 'antd';
import { CheckOutlined, FileTextOutlined, UserOutlined } from '@ant-design/icons';
                ...
                <div style={{ flex: 1, padding: '0 24px', overflowY: 'auto' }}>
                    {selectedDetailModel && (
                        <div style={{ paddingBottom: '80px' }}>
                            ...
                            <div style={{ marginBottom: "24px", padding: "10px", backgroundColor: "#f0f0f0", fontSize: "12px" }}>
                                <strong>Debug Info:</strong><br/>
                                Authors: {selectedDetailModel.authors ? JSON.stringify(selectedDetailModel.authors) : 'null'}<br/>
                                Paper: {selectedDetailModel.paper ? JSON.stringify(selectedDetailModel.paper) : 'null'}<br/>
                                Image: {selectedDetailModel.image || 'null'}
                            </div>

                            {/* Authors Section */}
                            {selectedDetailModel.authors && selectedDetailModel.authors.length > 0 && (
                                <div style={{ marginBottom: '24px' }}>
                                ...
                                <div style={{ marginBottom: '24px' }}>
                                    ...
                                    <div style={{
                                        ...
                                        <Image
                                            ...
                                            preview={{
                                                mask: <div style={{ fontSize: '16px' }}>🔍 View Chart</div>
                                            }}
                                        />
                                    </div>
                                </div>
