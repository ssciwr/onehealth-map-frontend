                ...
                setModels([
                    {
                        ...
                        icon: 'Bug',
                        color: '#754910',
                        details: 'Advanced climate model incorporating temperature, humidity, and precipitation data from NOAA weather stations.'
                    }
                ]);
            } finally {
                setLoading(false);
            ...
            <div style={{ padding: '16px 20px', }}>
                ...
                <p className="tertiary">
                    {loading ? 'Loading models...' :
                        error ? 'Error loading models (using fallback)' :
        ...
        >
          {selectedModelData ? (
              <Space>
                  ...
                  <span>{selectedModelData.title} - {selectedModelData.modelName}</span>
              </Space>
          ) : (
              <Space>
