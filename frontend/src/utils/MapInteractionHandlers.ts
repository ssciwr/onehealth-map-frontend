...
export class MapInteractionHandlers {
	// Map control functions
	public static handleZoomIn(map: L.Map | null): void {
		if (map) {
			map.zoomIn();
		}
	}

	public static handleZoomOut(map: L.Map | null): void {
		if (map) {
			map.zoomOut();
		}
	}

	public static handleResetZoom(map: L.Map | null): void {
		if (map) {
			map.setView([10, 12], 3);
		}
	}

	public static handleLocationFind(map: L.Map | null): void {
	...
	public static handleViewportChange(
	...
	public static createHighlightFeature(
	...
	public static createResetHighlight(
		mapMode: "grid" | "worldwide" | "europe-only",
		borderStyle: BorderStyle,
		dataExtremes: DataExtremes | null,
		convertedWorldwideGeoJSON: WorldwideGeoJSON | null,
	...
	public static createOnEachWorldwideFeature(
	...
	public static createOnEachEuropeOnlyFeature(
		currentVariableValue: string,
		highlightFeature: (e: L.LeafletMouseEvent) => void,
		resetHighlight: (e: L.LeafletMouseEvent) => void,
	) {
